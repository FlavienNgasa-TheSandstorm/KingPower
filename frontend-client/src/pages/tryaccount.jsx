...
export default function Account() {
  ...
  const stats = {
    ...
    completedOrders: orders.filter(o => o.status === 'delivered').length, // Livrées
    totalSpent: orders.reduce((sum, order) => sum + (Number(order.total) || 0), 0),
    pendingOrders: orders.filter(o => o.status === 'pending' || o.status === 'completed').length // En cours (attente + payée non livrée)
  };
    ...
    <div className="account-page">
      ...
      <div className="account-stats">
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <span className="stat-value">{(stats.totalSpent || 0).toFixed(2)} USD</span>
            ...
            {ordersLoading ? (
              ...
              <div className="orders-list">
                ...
                <div className="orders-filters">
                  <button className="orders-filter-btn active">Toutes</button>
                  <button className="orders-filter-btn">En cours</button>
                  <button className="orders-filter-btn">Livrées</button>
                </div>
